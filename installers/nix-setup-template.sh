...
if ./python -c "import pip; print(pip.__version__)" >/dev/null 2>&1; then
  echo "pip is available in this interpreter, skipping ensurepip."
else
  echo "pip not available, running ensurepip..."
  ./python -m ensurepip
fi
